...
************************************************/
define("ENDPOINT","http://localhost:2020/books");

$bases = array();
$bases["schema.owl"] = "http://tw.rpi.edu/schema/";
$bases["instances.rdf"] = "http://tw.rpi.edu/instances/";
...
if($_GET["q"]==null||$_GET["q"]=="") {
  ...
  if($mime=="application/rdf+xml") {
    ...
    // Look up tw:page for resource
    $query = 'PREFIX foaf: <http://xmlns.com/foaf/0.1/> '.
	     'PREFIX tw: <http://tw.rpi.edu/schema/> '.
             'SELECT ?page WHERE { '.
               '<'.$bases[$_GET["src"]].$_GET["q"].'> tw:page ?page . '.
